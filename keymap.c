...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LCtrl| Win  | LAlt |LOWER | /Space  /       \ Space\  |RAISE | RAlt |      |      |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    [_BASE] = LAYOUT(
            ...
            KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    _______,   _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______,
                            KC_LCTL, KC_LGUI, KC_LALT, MO(_LOWER), KC_SPC,   KC_SPC, MO(_RAISE), KC_RALT, _______, _______
            ),
     ...
     * |LShift|      |      |      |      |      |-------|    |-------|      |      |      |      |   <  |  >   |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LCtrl|      |      |LOWER | /Space  /       \Space \  |RAISE | RAlt |  Del |      |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    [_LOWER] = LAYOUT(
            ...
            KC_LSFT, _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, KC_NUBS, KC_NUBS,
                              KC_LCTL, _______, _______, MO(_LOWER), KC_SPC,   KC_SPC , MO(_RAISE), KC_RALT, KC_DEL, _______
            ),
    ...
    [_RAISE] = LAYOUT(
            ...
            _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______,
                              _______, _______, _______, MO(_LOWER), KC_SPC,   KC_SPC, MO(_RAISE), _______, _______, _______
            ),
